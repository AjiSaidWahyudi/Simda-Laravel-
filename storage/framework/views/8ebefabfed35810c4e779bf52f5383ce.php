...
<body>
    ...
    <table style="width:100%; border-bottom:3px solid #000; padding-bottom:10px;">
        <tr>
            <td style="width: 80px; text-align:center;">
                <img src="<?php echo e(public_path('logo/pemkot.png')); ?>" width="70">
            </td>
            <td style="text-align:center;">
                <div style="font-size:16px; font-weight:bold;">PEMERINTAH KOTA SAMARINDA</div>
                <div style="font-size:18px; font-weight:bold;">BUKU INVENTARIS GABUNGAN</div>
            </td>
    ...
    <table class="table">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $inventarisasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td><?php echo e($i + 1); ?></td>
                <td><?php echo e($item->kode_barang); ?></td>
                <td><?php echo e($item->kode_register); ?></td>
                <td><?php echo e($item->jenis_barang); ?></td>
                <td><?php echo e($item->merek_tipe); ?></td>
                <td><?php echo e($item->no_seri); ?></td>
                <td><?php echo e($item->bahan); ?></td>
                <td><?php echo e($item->cara_perolehan); ?></td>
                <td><?php echo e($item->tahun_beli); ?></td>
    ...
    <table style="width: 40%; margin-top:10px; border-collapse: collapse;">
        <tr>
            ...
            <td style="border:1px solid #333; padding:6px; text-align:right;">
                Rp <?php echo e(number_format($total_harga, 0, ',', '.')); ?>
    ...
    <table style="width:100%; margin-top:30px;">
        <tr>
            ...
            <td style="text-align:center; width:50%;">
                Samarinda, <?php echo e(now()->translatedFormat('d F Y')); ?> <br>
...
<?php /**PATH D:\project_aji\laravel\simda\resources\views/laporan/cetak.blade.php ENDPATH**/ ?>